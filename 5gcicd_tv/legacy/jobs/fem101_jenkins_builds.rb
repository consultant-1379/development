  ...
  SCHEDULER.every '30s', :first_in => 0 do |job|
    ...
    unless build_info.nil?
      ...
      if build_info["building"]
        ...
        current_percent = get_completion_percentage_fem101(jenkins_project[:job])
        ...
        current_percent = get_completion_percentage_fem101(jenkins_project[:pre_job])
      end
      send_event("#{title}_fem101_eiffel012", {
