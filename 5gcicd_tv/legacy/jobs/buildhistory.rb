...
$jenkins_jobs_to_be_tracked = [
  'testing-adp-cicd-jenkins',
  'testing-system-jenkins',
  'testing-udm-jenkins',
  'helm-deploy-elk',
  'helm-deploy-jnksnr',
  'helm-pkg-elk',
  'helm-pkg-grafana',
  'helm-pkg-jenkinssonar',
  'helm-pkg-prometheus',
  'new-jenkins-chart',
  'build-doc-job-UDM',
  'build-doc-upload-job-UDM'
]
...
def get_all_jobs
  ...
  request = Net::HTTP::Get.new("/api/json?tree=jobs[name]")
...
SCHEDULER.every '60s', :first_in => 0 do
  ...
  #jenkins_jobs_to_be_tracked = get_all_jobs
